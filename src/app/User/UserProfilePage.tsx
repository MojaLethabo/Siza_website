...
const UserProfilePage = () => {
  ...
  useEffect(() => {
    ...
    async function fetchUser() {
      try {
        const res = await fetch(`https://myappapi-yo3p.onrender.com/user?userID=${userID}`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-white p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="bg-blue-700 p-6 flex items-center justify-between">
          ...
          <div className="w-20 h-20 rounded-full bg-white border-4 border-blue-300 overflow-hidden shadow-md relative">
            {user.ProfilePhoto ? (
              <Image
